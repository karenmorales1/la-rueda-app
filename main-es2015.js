...
module.exports = __webpack_require__(/*! C:\Users\Usuario\Downloads\la-rueda-app-full\src\main.ts */"zUnb");
...
LoginComponent = __decorate([
    ...
    __metadata("design:paramtypes", [_services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]])
], LoginComponent);
...
let ApiService = class ApiService {
        ...
        return new rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"]((observer) => {
            if (email.trim() === 'cand_0011@larueda.com' && password.trim() === 'Password123') {
                ...
                observer.next({
                    ...
                    user: { email, candidate_code: this.candidateCode }
                });
            }
            else {
    ...
    getContacts() {
        return new rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"]((observer) => {
            observer.next([
                { nombre: 'Juan Pérez', celular: '3001112233', placa: 'ABC123' },
                { nombre: 'Ana Ruiz', celular: '3002223344', placa: 'XYZ987' }
            ]);
            observer.complete();
        });
    }
...
/* harmony import */ var _pages_contacts_contacts_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./pages/contacts/contacts.component */ "ZuGw");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var _raw_loader_contacts_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! raw-loader!./contacts.component.html */ "BQel");
/* harmony import */ var _contacts_component_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./contacts.component.css */ "rhmd");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _services_api_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../services/api.service */ "H+bZ");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
let ContactsComponent = class ContactsComponent {
    ...
    loadContacts() {
        this.api.getContacts().subscribe({
            ...
            error: () => this.showMessage('❌ Error al cargar contactos', 'red')
        });
    }
    createContact() {
        const nuevo = {
        ...
        this.api.createContact(nuevo).subscribe({
            next: () => {
                this.contacts.push(nuevo); // 👈 agrega el nuevo contacto a la lista
                this.newName = '';
                this.newPhone = '';
                this.newPlate = '';
                this.showMessage('✅ Contacto creado correctamente', 'green');
            },
            error: () => {
                this.showMessage('❌ Error al crear el contacto', 'red');
            }
        });
    }
    uploadBulk() {
        try {
            const data = JSON.parse(this.bulkText);
            const rows = data.rows || data.filas || [];
            if (rows.length === 0) {
            ...
            this.api.bulkContacts(rows).subscribe({
                next: () => {
                    ...
                    this.contacts = [...this.contacts, ...rows];
                    this.showMessage('✅ Carga masiva exitosa', 'green');
                },
                error: () => this.showMessage('❌ Error en la carga masiva', 'red')
            });
        }
        catch (_a) {
...
/* harmony import */ var _pages_contacts_contacts_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./pages/contacts/contacts.component */ "ZuGw");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<h2>Iniciar sesión</h2>\n\n<input\n  type=\"email\"\n  [(ngModel)]=\"email\"\n  placeholder=\"Correo electrónico\"\n/>\n\n<input\n  type=\"password\"\n  [(ngModel)]=\"password\"\n  placeholder=\"Contraseña\"\n/>\n\n<button (click)=\"login()\">Login</button>\n\n<p [style.color]=\"messageColor\">{{ message }}</p>\n");
